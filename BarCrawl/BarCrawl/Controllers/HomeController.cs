...
namespace BarCrawl.Controllers
{
    public class HomeController : Controller
    {
        ...
        public List<YelpModel> GetBars(string city)
        {
            HttpWebRequest request = WebRequest.CreateHttp($"https://api.yelp.com/v3/businesses/search?term=bars&location=holland, mi");
        ...
        {
            List<YelpModel>bars = GetBars(city);
            return View(bars);
        }
